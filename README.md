...
이처럼 급증하는 마약사범에도 불구하고, 실형을 선고받는 비율은 오히려 감소해 논란이 일고 있다.
실제 마약사범의 실형 비율은 2020년 53.7%에서 이듬해 50.6%로, 2022년엔 48.1%로 감소해왔다.
이에 마약 근절을 위해 마약사범 처벌 수위를 강화해야한다는 목소리가 높아지고 있다.

마약범죄 판례 조회 서비스는 이러한 사회적 분위기 속에서 출발했다.
본 서비스의 목적은 마약범죄에 관한 보다 많은 정보 제공에 있다.
본 서비스는 사용자가 선택한 마약 종류와 형량에 따라 관련 판례를 제공하기 때문에, 마약범죄에 한해 기존의 판례 조회 서비스보다 더 특화된 정보를 제공한다.
